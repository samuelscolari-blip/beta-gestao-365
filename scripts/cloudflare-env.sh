...
runtime_root="${CLOUDFLARE_RUNTIME_ROOT:-${project_root}/.cloudflare-runtime}"
...
export CLOUDFLARE_ENV_READY=1
export CLOUDFLARE_PROJECT_ROOT="${project_root}"
...
# The runtime may provide a global npm cache. Keep any read-only image seed
# separate and make this project's writable cache authoritative.
